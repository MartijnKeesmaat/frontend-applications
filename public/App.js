...
const NavLink$1 = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	let { to = "" } = $$props;
...
const App = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
  ...
  onMount(() => {
	...
	return `${validate_component(Router, 'Router').$$render($$result, { url: url }, {}, {
	  ...
	  <nav class="main-nav">
	    ${validate_component(NavLink$1, 'NavLink').$$render($$result, { to: "/intro" }, {}, {
		default: () => `
	    ...
	    <div class="main-nav__links">
	      ...
	      ${validate_component(NavLink$1, 'NavLink').$$render($$result, { to: "retrieve-data" }, {}, { default: () => `Retrieve Data` })}
	    </div>
	  </nav>
