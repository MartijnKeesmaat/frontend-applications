...
const Video = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
  ...
  onMount(() => {
	...
	<section class="video-view svelte-1rebh4z">

	  <h1 class="video-title">Onafhankelijkheid</h1>

	  <video controls class="svelte-1rebh4z">
	    <source src="./snow-monks.mp4" type="video/mp4">
	  </video>
	  <button id="snap">Snap Photo</button>
	  <canvas id="snapshot-canvas" width="640" height="480" class="svelte-1rebh4z"></canvas>
	</section>`;
});
