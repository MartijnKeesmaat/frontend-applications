...
const Mask = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<canvas id="mask" width="500" height="300" class="svelte-181bqbo"></canvas>
	<img id="bg-img" src="./img/dummy1.jpg" alt="" class="svelte-181bqbo">`;
});
