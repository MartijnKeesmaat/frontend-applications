...
const VideoSnapshot = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
  ...
  function setCanvasDimensions() {
	...
	return `<section class="video-view svelte-benwcj">
	  <div class="outer-wrapper svelte-benwcj">
	    <div class="video-wrapper svelte-benwcj">

	      <div class="video-meta-description svelte-benwcj">
	        <div class="video-count">
	          <h3 class="video-count__title svelte-benwcj">Foto</h3>
	          <p class="video-count__count svelte-benwcj">${escape(photoCount)}</p>
	        </div>

	        <h1 class="video-title svelte-benwcj">${escape(videoTitle)}</h1>
	      </div>

	      <div class="video-instructions__container svelte-benwcj">
	        <div class="video-instructions svelte-benwcj">
	          <div class="divie svelte-benwcj">
	            <h3 class="svelte-benwcj">
	              Maak momentopnames van de gebeurtenis, de laatste zie je straks
	              terug
	            </h3>
	            <button class="svelte-benwcj">
	              <span class="button-round svelte-benwcj">
	                <img src="/icons/arrow-solid.svg" alt="" class="svelte-benwcj">
	              </span>
	            </button>
	          </div>
	        </div>
	        <video${add_attribute("poster", posterSrc, 0)} class="svelte-benwcj">
	          <source${add_attribute("src", videoSrc, 0)} type="video/mp4">
	        </video>
	      </div>

	      <button id="snap" class="svelte-benwcj">
	        <img src="/icons/camera.svg" alt="" class="svelte-benwcj">
	      </button>
	    </div>

	    <div id="snapshots-taken" class="svelte-benwcj">
	      <h4 class="svelte-benwcj">Jouw foto's</h4>
	    </div>

	    <canvas id="snapshot-canvas" width="640" height="480" class="svelte-benwcj"></canvas>
	  </div>
	</section>`;
});
