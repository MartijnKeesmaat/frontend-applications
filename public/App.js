...
const Home = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
  ...
  onMount(() => {
	...
	return `<div class="mask-wrapper">
	  ...
	  <img id="bg-img" src="https://scontent-amt2-1.xx.fbcdn.net/v/t1.0-9/66119555_1102391759958724_1637141035295440896_n.jpg?_nc_cat=110&_nc_oc=AQkG3SAsAcfqJVWoJabTflX3U5kM6EWTLyFYbdc1eDBiTA6Kx364OmdiXynaTy3YmyI&_nc_ht=scontent-amt2-1.xx&oh=c40e6640448e035edb073b9e74c43320&oe=5E1D3AA7" alt="https://www.facebook.com/Kleuruwverleden/">
	</div>
...
const Video = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
  ...
  function setCanvasDimensions() {
	...
	return `<div class="mask-wrapper">
	  <canvas id="mask" width="500" height="300"></canvas>
	  <img id="bg-img" src="https://scontent-amt2-1.xx.fbcdn.net/v/t1.0-9/27654433_764037853794118_4739243479831552770_n.jpg?_nc_cat=108&_nc_oc=AQlDa3nzcVUyWNXYYwZEXB8Kev00AxKqAS7BFDEmsjf5XUh_ovHWoSt79F4l7EvEyRw&_nc_ht=scontent-amt2-1.xx&oh=e76eebc07cb1521fc411076a32b46eb0&oe=5E1871CE" alt="https://www.facebook.com/Kleuruwverleden/">
	</div>

	<section class="video-view svelte-1qneg2h">
	  <div class="outer-wrapper svelte-1qneg2h">
	    <div class="video-wrapper svelte-1qneg2h">

	      <div class="video-meta-description svelte-1qneg2h">
	        <div class="video-count">
	          <h3 class="video-count__title svelte-1qneg2h">Foto</h3>
	          <p class="video-count__count svelte-1qneg2h">01</p>
	        </div>

	        <h1 class="video-title svelte-1qneg2h">Marine landing</h1>
	      </div>

	      <div class="video-instructions__container svelte-1qneg2h">
	        <div class="video-instructions svelte-1qneg2h">
	          <div class="divie svelte-1qneg2h">
	            <h3 class="svelte-1qneg2h">
	              Maak momentopnames van de gebeurtenis, de laatste zie je straks
	              terug
	            </h3>
	            <button class="svelte-1qneg2h">
	              <span class="button-round svelte-1qneg2h">
	                <img src="/icons/arrow-solid.svg" alt="" class="svelte-1qneg2h">
	              </span>
	            </button>
	          </div>
	        </div>
	        <video poster="/img/poster.jpg" class="svelte-1qneg2h">
	          <source src="/video/landing-marine.mp4" type="video/mp4">
	        </video>
	      </div>

	      <button id="snap" class="svelte-1qneg2h">
	        <img src="/icons/camera.svg" alt="" class="svelte-1qneg2h">
	      </button>
	    </div>

	    <div id="snapshots-taken" class="svelte-1qneg2h">
	      <h4 class="svelte-1qneg2h">Jouw foto's</h4>
	    </div>

	    <canvas id="snapshot-canvas" width="640" height="480" class="svelte-1qneg2h"></canvas>
	  </div>
	</section>`;
});
	    ...
	    <div class="video-wrapper svelte-179ws03">
	      ...
	      <div class="video-meta-description svelte-179ws03">
	        <div class="video-count">
	          ...
	          <p class="video-count__count svelte-179ws03">02</p>
	        </div>

	        <h1 class="video-title svelte-179ws03">Wegversperingen</h1>
	      </div>
