...
/* src/routes/Mask.svelte generated by Svelte v3.12.1 */

const css$1 = {
	code: "canvas.svelte-iwp4w5{position:fixed;z-index:2}#bg-img.svelte-iwp4w5{position:fixed;z-index:1;object-fit:cover;height:100vh;width:100vw}.hero.svelte-iwp4w5{position:relative;z-index:3;display:flex;align-items:center;justify-content:space-between;width:100%;max-width:900px;height:100vh;margin:0 auto;color:#fff}.hero__intro.svelte-iwp4w5{max-width:507px}.hero__cta.svelte-iwp4w5 a.svelte-iwp4w5{display:flex;align-items:center;justify-content:center;text-decoration:none !important;color:#fff}.hero__cta.svelte-iwp4w5:hover .button-round.svelte-iwp4w5{cursor:pointer;border:2px solid rgba(255, 255, 255, 0.6)}.hero__cta.svelte-iwp4w5:hover .title-main.svelte-iwp4w5{transform:translateX(2px)}.hero__cta.svelte-iwp4w5:hover .title-highlight.svelte-iwp4w5{transform:translateX(4px)}.hero__cta.svelte-iwp4w5:hover .button-round img.svelte-iwp4w5{transform:rotate(-30deg)}.hero__cta.svelte-iwp4w5 .button-round.svelte-iwp4w5{margin-right:15px}",
	map: "{\"version\":3,\"file\":\"Mask.svelte\",\"sources\":[\"Mask.svelte\"],\"sourcesContent\":[\"<script>\\n  import { onMount } from \\\"svelte\\\";\\n  import NavLink from \\\"../components/NavLink.svelte\\\";\\n  onMount(() => {\\n    drawMask();\\n  });\\n\\n  function drawMask() {\\n    const canvas = document.getElementById(\\\"mask\\\");\\n    const ctx = canvas.getContext(\\\"2d\\\");\\n\\n    const w = (canvas.width = window.innerWidth);\\n    const h = (canvas.height = window.innerHeight);\\n\\n    let offsetX, offsetY;\\n\\n    function draw(cx, cy, radius) {\\n      ctx.save();\\n      ctx.clearRect(0, 0, w, h);\\n\\n      const radialGradient = ctx.createRadialGradient(\\n        cx,\\n        cy,\\n        1,\\n        cx,\\n        cy,\\n        radius\\n      );\\n\\n      radialGradient.addColorStop(0, \\\"rgba(0, 0, 0, 0.3)\\\");\\n      radialGradient.addColorStop(0.65, \\\"rgba(0, 0, 0, 0.3)\\\");\\n      radialGradient.addColorStop(1, \\\"rgba(0, 0, 0, 0)\\\");\\n\\n      ctx.beginPath();\\n\\n      ctx.fillStyle = \\\"rgba(0, 0, 0, 0.9)\\\";\\n      ctx.fillRect(0, 0, w, h);\\n\\n      ctx.globalCompositeOperation = \\\"destination-out\\\";\\n\\n      ctx.arc(cx, cy, radius, 0, Math.PI * 2, false);\\n      ctx.fillStyle = radialGradient;\\n      ctx.fill();\\n\\n      ctx.restore();\\n    }\\n\\n    function mouseMove(e) {\\n      e.preventDefault();\\n      e.stopPropagation();\\n\\n      const mouseX = parseInt(e.clientX - offsetX);\\n      const mouseY = parseInt(e.clientY - offsetY);\\n\\n      draw(mouseX, mouseY, 400);\\n    }\\n\\n    function reOffset() {\\n      const BB = canvas.getBoundingClientRect();\\n      offsetX = BB.left;\\n      offsetY = BB.top;\\n    }\\n\\n    reOffset();\\n\\n    window.onscroll = function(e) {\\n      reOffset();\\n    };\\n\\n    window.onresize = function(e) {\\n      reOffset();\\n    };\\n\\n    document.body.addEventListener(\\\"mousemove\\\", mouseMove, false);\\n    document.body.addEventListener(\\\"touchmove\\\", mouseMove, false);\\n\\n    draw(w / 2, h / 2, 400);\\n  }\\n</script>\\n\\n<style>\\n  canvas {\\n    position: fixed;\\n    z-index: 2;\\n  }\\n\\n  #bg-img {\\n    position: fixed;\\n    z-index: 1;\\n    object-fit: cover;\\n    height: 100vh;\\n    width: 100vw;\\n  }\\n\\n  .hero {\\n    position: relative;\\n    z-index: 3;\\n\\n    display: flex;\\n    align-items: center;\\n    justify-content: space-between;\\n\\n    width: 100%;\\n    max-width: 900px;\\n    height: 100vh;\\n    margin: 0 auto;\\n\\n    color: #fff;\\n  }\\n\\n  .hero__intro {\\n    max-width: 507px;\\n  }\\n\\n  .hero__cta a {\\n    display: flex;\\n    align-items: center;\\n    justify-content: center;\\n\\n    text-decoration: none !important;\\n\\n    color: #fff;\\n  }\\n\\n  .hero__cta:hover .button-round {\\n    cursor: pointer;\\n\\n    border: 2px solid rgba(255, 255, 255, 0.6);\\n  }\\n\\n  .hero__cta:hover .title-main {\\n    transform: translateX(2px);\\n  }\\n\\n  .hero__cta:hover .title-highlight {\\n    transform: translateX(4px);\\n  }\\n\\n  .hero__cta:hover .button-round img {\\n    transform: rotate(-30deg);\\n  }\\n\\n  .hero__cta .button-round {\\n    margin-right: 15px;\\n  }\\n</style>\\n\\n<div class=\\\"mask-wrapper\\\">\\n  <canvas id=\\\"mask\\\" width=\\\"500\\\" height=\\\"300\\\" />\\n  <img id=\\\"bg-img\\\" src=\\\"./img/dummy1.jpg\\\" alt=\\\"\\\" />\\n</div>\\n\\n<section class=\\\"hero\\\">\\n  <div class=\\\"hero__intro\\\">\\n    <h1 class=\\\"title-main\\\">\\n      Wat is jouw\\n      <span class=\\\"title-highlight\\\">Perspectief</span>\\n    </h1>\\n    <p class=\\\"body\\\">\\n      Na de uitvinding van de fotografie in 1839 werd de rol van de expeditie\\n      overgenomen door de fotograaf. Landschappen, mensen en hun\\n      leefomstandigheden waren de belangrijkste onderwerpen. Het is aan jou de\\n      taak om deze zo goed mogelijk vast te leggen.\\n    </p>\\n  </div>\\n\\n  <div class=\\\"hero__cta\\\">\\n    <NavLink to=\\\"video\\\">\\n      <a>\\n        <button class=\\\"button-round\\\">\\n          <img src=\\\"icons/arrow.svg\\\" alt=\\\"\\\" />\\n        </button>\\n        <h3 class=\\\"title-main\\\">\\n          Vertel\\n          <span class=\\\"title-highlight\\\">Je verhaal</span>\\n        </h3>\\n      </a>\\n    </NavLink>\\n  </div>\\n</section>\\n\"],\"names\":[],\"mappings\":\"AAiFE,MAAM,cAAC,CAAC,AACN,QAAQ,CAAE,KAAK,CACf,OAAO,CAAE,CAAC,AACZ,CAAC,AAED,OAAO,cAAC,CAAC,AACP,QAAQ,CAAE,KAAK,CACf,OAAO,CAAE,CAAC,CACV,UAAU,CAAE,KAAK,CACjB,MAAM,CAAE,KAAK,CACb,KAAK,CAAE,KAAK,AACd,CAAC,AAED,KAAK,cAAC,CAAC,AACL,QAAQ,CAAE,QAAQ,CAClB,OAAO,CAAE,CAAC,CAEV,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,CACnB,eAAe,CAAE,aAAa,CAE9B,KAAK,CAAE,IAAI,CACX,SAAS,CAAE,KAAK,CAChB,MAAM,CAAE,KAAK,CACb,MAAM,CAAE,CAAC,CAAC,IAAI,CAEd,KAAK,CAAE,IAAI,AACb,CAAC,AAED,YAAY,cAAC,CAAC,AACZ,SAAS,CAAE,KAAK,AAClB,CAAC,AAED,wBAAU,CAAC,CAAC,cAAC,CAAC,AACZ,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,CACnB,eAAe,CAAE,MAAM,CAEvB,eAAe,CAAE,IAAI,CAAC,UAAU,CAEhC,KAAK,CAAE,IAAI,AACb,CAAC,AAED,wBAAU,MAAM,CAAC,aAAa,cAAC,CAAC,AAC9B,MAAM,CAAE,OAAO,CAEf,MAAM,CAAE,GAAG,CAAC,KAAK,CAAC,KAAK,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,AAC5C,CAAC,AAED,wBAAU,MAAM,CAAC,WAAW,cAAC,CAAC,AAC5B,SAAS,CAAE,WAAW,GAAG,CAAC,AAC5B,CAAC,AAED,wBAAU,MAAM,CAAC,gBAAgB,cAAC,CAAC,AACjC,SAAS,CAAE,WAAW,GAAG,CAAC,AAC5B,CAAC,AAED,wBAAU,MAAM,CAAC,aAAa,CAAC,GAAG,cAAC,CAAC,AAClC,SAAS,CAAE,OAAO,MAAM,CAAC,AAC3B,CAAC,AAED,wBAAU,CAAC,aAAa,cAAC,CAAC,AACxB,YAAY,CAAE,IAAI,AACpB,CAAC\"}"
};
...
const Mask = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
  ...
  onMount(() => {
	...
	return `<div class="mask-wrapper">
	  <canvas id="mask" width="500" height="300" class="svelte-iwp4w5"></canvas>
	  <img id="bg-img" src="./img/dummy1.jpg" alt="" class="svelte-iwp4w5">
	</div>

	<section class="hero svelte-iwp4w5">
	  <div class="hero__intro svelte-iwp4w5">
	    <h1 class="title-main">
	      Wat is jouw
	      <span class="title-highlight">Perspectief</span>
	    </h1>
	  ...
	  <div class="hero__cta svelte-iwp4w5">
	    ${validate_component(NavLink, 'NavLink').$$render($$result, { to: "video" }, {}, {
		default: () => `
	      <a class="svelte-iwp4w5">
	        <button class="button-round svelte-iwp4w5">
	          <img src="icons/arrow.svg" alt="" class="svelte-iwp4w5">
	        </button>
	        <h3 class="title-main svelte-iwp4w5">
	          Vertel
	          <span class="title-highlight svelte-iwp4w5">Je verhaal</span>
	        </h3>
	      </a>
	    `
	})}
	...
	return `${validate_component(Router, 'Router').$$render($$result, { url: url }, {}, {
	  ...
	  <nav class="main-nav">
	    ...
	    <div class="main-nav__links">
	      ...
	      ${validate_component(NavLink, 'NavLink').$$render($$result, { to: "mask" }, {}, { default: () => `Mask` })}
	  ...
	  <div>
	    ...
	    ${validate_component(Route, 'Route').$$render($$result, { path: "mask", component: Mask }, {}, {})}
	  </div>
	`
	})}`;
});
