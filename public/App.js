...
const VideoSnapshot = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
  ...
  let { videoSrc, videoTitle, localStorageLink, photoCount, posterSrc, linksTo } = $$props;
  ...
  function toggleNext() {
	...
	if ($$props.linksTo === void 0 && $$bindings.linksTo && linksTo !== void 0) $$bindings.linksTo(linksTo);

	$$result.css.add(css$1);

	return `<article class="video-view svelte-brg9k8">
	  <div class="video-and-snapshot-wrapper svelte-brg9k8">
	    <div class="video-wrapper svelte-brg9k8">

	      <section class="video-meta-description svelte-brg9k8">
	        <div class="video-count">
	          <h3 class="video-count__title svelte-brg9k8">Foto</h3>
	          <p class="video-count__count svelte-brg9k8">${escape(photoCount)}</p>
	        </div>

	        <h1 class="video-title svelte-brg9k8">${escape(videoTitle)}</h1>
	      </section>

	      <div class="video-container svelte-brg9k8">
	        <div class="video-overlay svelte-brg9k8" id="video-instructions">
	          <h3 class="svelte-brg9k8">
	            Maak momentopnames van de gebeurtenis, de laatste zie je straks
	            terug
	          </h3>

	          <button class="svelte-brg9k8">
	            <span class="button-round svelte-brg9k8">
	              <img src="/icons/arrow-solid.svg" alt="" class="svelte-brg9k8">
	            </span>
	          </button>
	        </div>

	        ${ isShowNextVideo ? `${validate_component(NavLink, 'NavLink').$$render($$result, { to: linksTo }, {}, {
		default: () => `
	            <div class="video-overlay next-video svelte-brg9k8">
	              <div class="flex svelte-brg9k8">
	                <h3 class="svelte-brg9k8">Bekijk het volgende video fragment</h3>
	                <button class="svelte-brg9k8">
	                  <span class="button-round svelte-brg9k8">
	                    <img src="/icons/arrow.svg" alt="" class="svelte-brg9k8">
	                  </span>
	                </button>
	              </div>
	            </div>
	        ...
	        <video${add_attribute("poster", posterSrc, 0)} class="svelte-brg9k8">
	          <source${add_attribute("src", videoSrc, 0)} type="video/mp4">
	        </video>
	      </div>

	      ${ !isShowNextVideo ? `<button id="snap" class="svelte-brg9k8">
	          <img src="/icons/camera.svg" alt="" class="svelte-brg9k8">
	        </button>` : `` }
	    </div>

	    <div id="snapshots-taken" class="svelte-brg9k8">
	      <h4 class="svelte-brg9k8">Jouw foto's</h4>
	    </div>

	    <canvas id="snapshot-canvas" width="640" height="480" class="svelte-brg9k8"></canvas>
	  </div>
	</article>`;
});
