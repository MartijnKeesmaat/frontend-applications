...
const css$1 = {
	code: "#snapshot-canvas.svelte-xbmc8f{position:fixed}video.svelte-xbmc8f{width:888px;height:496px;background:#000}.video-view.svelte-xbmc8f{position:fixed;z-index:10}.video-view.svelte-xbmc8f{position:relative;z-index:3;display:flex;align-items:center;justify-content:center;width:100%;max-width:900px;height:100vh;margin:0 auto;color:#fff}.video-wrapper.svelte-xbmc8f{position:relative;margin-left:100px}.video-meta-description.svelte-xbmc8f{display:flex;justify-content:space-between}.video-title.svelte-xbmc8f{margin:20px 0;letter-spacing:4.3px;text-transform:uppercase;color:#ffe6a0;font-size:30px;font-weight:400}.video-count__title.svelte-xbmc8f{margin:0;margin-top:5px;letter-spacing:1.91px;text-transform:uppercase;font-size:15px;font-weight:400}.video-count__count.svelte-xbmc8f{margin:0;margin-top:-5px;letter-spacing:5.3px;font-family:\"Playfair Display\", serif;font-size:42px;line-height:1}video.svelte-xbmc8f:focus{outline:none}#snap.svelte-xbmc8f{position:absolute;right:0;bottom:0;display:flex;align-items:center;justify-content:center;width:55px;height:55px;opacity:0;transition:0.3s all ease;background:#ffe6a0;box-shadow:0 0 30px 4px rgba(255, 230, 160, 0.4)}#snap.svelte-xbmc8f img.svelte-xbmc8f{width:20px;height:28px}#snapshots-taken.svelte-xbmc8f{margin-bottom:100px;margin-left:50px}#snapshots-taken.svelte-xbmc8f h4.svelte-xbmc8f{width:80px;margin-bottom:41px;letter-spacing:2px;text-transform:uppercase;opacity:0;font-size:14px;line-height:1.4}.outer-wrapper.svelte-xbmc8f{display:flex;align-items:flex-end}.video-instructions__container.svelte-xbmc8f{position:relative;width:100%;height:100%}.video-instructions.svelte-xbmc8f{position:absolute;z-index:10;top:0;left:0;display:flex;align-items:center;justify-content:center;width:100%;height:100%;padding-bottom:30px;transition:0.3s all ease;background:rgba(10, 10, 10, 0.7);cursor:pointer}.video-instructions.svelte-xbmc8f:hover{background:rgba(0, 0, 0, 0.35)}.video-instructions.svelte-xbmc8f:hover .button-round.svelte-xbmc8f{border:2px solid rgba(255, 255, 255, 0.6)}.video-instructions.svelte-xbmc8f:hover h3.svelte-xbmc8f{opacity:1}.video-instructions.svelte-xbmc8f button.svelte-xbmc8f{border:none;background:none}.video-instructions.svelte-xbmc8f .divie.svelte-xbmc8f{display:flex;align-items:center;justify-content:center}.video-instructions__container.svelte-xbmc8f h3.svelte-xbmc8f{max-width:240px;margin:0;margin-right:10px;transition:0.3s all ease;text-align:right;letter-spacing:1px;font-size:17px;font-weight:400;opacity:0.7}.video-instructions.svelte-xbmc8f button img.svelte-xbmc8f{width:9px;height:14px}",
	map: "{\"version\":3,\"file\":\"VideoSnapshot.svelte\",\"sources\":[\"VideoSnapshot.svelte\"],\"sourcesContent\":[\"<script>\\n  import { onMount } from \\\"svelte\\\";\\n  export let videoSrc;\\n  export let videoTitle;\\n  export let localStorageLink;\\n  export let photoCount;\\n  export let posterSrc;\\n\\n  let context, video, canvas, w, h;\\n\\n  onMount(() => {\\n    initVideoSnapshot();\\n    showVideo();\\n    toggleNext();\\n  });\\n\\n  // #### VIDEO SNAPSHOT #####\\n  // 1. init video & Canvas\\n  // 2. draw frame from video on the canvas\\n  // 3. Convert the frame to an img(Base64) and store it\\n  // 4. Style the img\\n  // 5. Add it to the DOM\\n  // 6. Clear the canvas\\n\\n  function initVideoSnapshot() {\\n    video = document.querySelector(\\\"video\\\");\\n    canvas = document.getElementById(\\\"snapshot-canvas\\\");\\n    context = canvas.getContext(\\\"2d\\\");\\n    video.addEventListener(\\\"loadedmetadata\\\", setCanvasDimensions, false);\\n  }\\n\\n  function setCanvasDimensions() {\\n    const ratio = video.videoWidth / video.videoHeight;\\n    w = video.videoWidth - 100;\\n    h = parseInt(w / ratio, 10);\\n    canvas.width = w;\\n    canvas.height = h;\\n  }\\n\\n  function takeSnapShot() {\\n    drawVideoFrame();\\n    const snapshot = getVideoFrameFromCanvas();\\n    styleSnapshot(snapshot);\\n    addSnapshotToDOM(snapshot);\\n    context.clearRect(0, 0, canvas.width, canvas.height);\\n  }\\n\\n  function drawVideoFrame() {\\n    context.fillRect(0, 0, w, h);\\n    context.drawImage(video, 0, 0, w, h);\\n  }\\n\\n  function getVideoFrameFromCanvas() {\\n    const image = canvas\\n      .toDataURL(\\\"image/png\\\")\\n      .replace(\\\"image/png\\\", \\\"image/octet-stream\\\");\\n    localStorage.setItem(localStorageLink, image);\\n    const snapshot = new Image();\\n    snapshot.src = image;\\n    return snapshot;\\n  }\\n\\n  function styleSnapshot(snapshot) {\\n    snapshot.style.border = \\\"2px solid #c7c6c3\\\";\\n    snapshot.width = 136;\\n    snapshot.height = 91;\\n    snapshot.style.position = \\\"absolute\\\";\\n    let random = Math.floor(Math.random() * 30) + 1;\\n    random *= Math.floor(Math.random() * 2) == 1 ? 1 : -1;\\n\\n    snapshot.style.transform = `rotate(${random}deg)`;\\n  }\\n\\n  function addSnapshotToDOM(snapshot) {\\n    document.querySelector(\\\"#snapshots-taken h4\\\").style.opacity = 1;\\n    document.querySelector(\\\"#snapshots-taken\\\").appendChild(snapshot);\\n  }\\n\\n  // #### VIDEO INSTRUCTIONS #####\\n  function showVideo() {\\n    const videoInstructions = document.querySelector(\\\".video-instructions\\\");\\n    const snapButton = document.getElementById(\\\"snap\\\");\\n    const videoPlayer = document.querySelector(\\\"video\\\");\\n\\n    function toggleVideoClass() {\\n      videoInstructions.style.opacity = 0;\\n      videoInstructions.style.visibility = \\\"hidden\\\";\\n      videoPlayer.play();\\n\\n      setTimeout(function() {\\n        snapButton.style.opacity = 1;\\n      }, 1200);\\n    }\\n\\n    videoInstructions.addEventListener(\\\"click\\\", toggleVideoClass);\\n  }\\n\\n  function toggleNext() {\\n    document.querySelector(\\\"video\\\").addEventListener(\\\"ended\\\", myHandler, false);\\n\\n    function myHandler(e) {\\n      const videoInstructions = document.querySelector(\\\".video-instructions\\\");\\n      const snapButton = document.getElementById(\\\"snap\\\");\\n      console.log(\\\"a\\\");\\n      console.log(videoInstructions);\\n      snapButton.style.opacity = 0;\\n      videoInstructions.style.opacity = 1;\\n      videoInstructions.style.visibility = \\\"visible\\\";\\n\\n      document.querySelector(\\\".video-instructions__container\\\").innerHTML = `\\n          <NavLink class=\\\"next-video\\\" to=\\\"/video2\\\">\\n            <h3>Bekijk de volgende video</h3>\\n          </NavLink>\\n        `;\\n      console.log(\\\"videoInstructions\\\");\\n    }\\n  }\\n</script>\\n\\n<style>\\n  #snapshot-canvas {\\n    position: fixed;\\n  }\\n\\n  video {\\n    width: 888px;\\n    height: 496px;\\n\\n    background: #000;\\n  }\\n\\n  .video-view {\\n    position: fixed;\\n    z-index: 10;\\n  }\\n\\n  .video-view {\\n    position: relative;\\n    z-index: 3;\\n\\n    display: flex;\\n    align-items: center;\\n    justify-content: center;\\n\\n    width: 100%;\\n    max-width: 900px;\\n    height: 100vh;\\n    margin: 0 auto;\\n\\n    color: #fff;\\n  }\\n\\n  .video-wrapper {\\n    position: relative;\\n\\n    margin-left: 100px;\\n  }\\n\\n  .video-meta-description {\\n    display: flex;\\n    justify-content: space-between;\\n  }\\n\\n  .video-title {\\n    margin: 20px 0;\\n\\n    letter-spacing: 4.3px;\\n    text-transform: uppercase;\\n\\n    color: #ffe6a0;\\n\\n    font-size: 30px;\\n    font-weight: 400;\\n  }\\n\\n  .video-count__title {\\n    margin: 0;\\n    margin-top: 5px;\\n\\n    letter-spacing: 1.91px;\\n    text-transform: uppercase;\\n\\n    font-size: 15px;\\n    font-weight: 400;\\n  }\\n\\n  .video-count__count {\\n    margin: 0;\\n    margin-top: -5px;\\n\\n    letter-spacing: 5.3px;\\n\\n    font-family: \\\"Playfair Display\\\", serif;\\n    font-size: 42px;\\n    line-height: 1;\\n  }\\n\\n  video:focus {\\n    outline: none;\\n  }\\n\\n  #snap {\\n    position: absolute;\\n    right: 0;\\n    bottom: 0;\\n\\n    display: flex;\\n    align-items: center;\\n    justify-content: center;\\n\\n    width: 55px;\\n    height: 55px;\\n\\n    opacity: 0;\\n    transition: 0.3s all ease;\\n    background: #ffe6a0;\\n    box-shadow: 0 0 30px 4px rgba(255, 230, 160, 0.4);\\n  }\\n\\n  #snap img {\\n    width: 20px;\\n    height: 28px;\\n  }\\n\\n  #snapshots-taken {\\n    margin-bottom: 100px;\\n    margin-left: 50px;\\n  }\\n\\n  #snapshots-taken h4 {\\n    width: 80px;\\n    margin-bottom: 41px;\\n\\n    letter-spacing: 2px;\\n    text-transform: uppercase;\\n\\n    opacity: 0;\\n\\n    font-size: 14px;\\n    line-height: 1.4;\\n  }\\n\\n  .outer-wrapper {\\n    display: flex;\\n    align-items: flex-end;\\n  }\\n\\n  .video-instructions__container {\\n    position: relative;\\n\\n    width: 100%;\\n    height: 100%;\\n  }\\n\\n  .video-instructions {\\n    position: absolute;\\n    z-index: 10;\\n    top: 0;\\n    left: 0;\\n\\n    display: flex;\\n    align-items: center;\\n    justify-content: center;\\n\\n    width: 100%;\\n    height: 100%;\\n    padding-bottom: 30px;\\n\\n    transition: 0.3s all ease;\\n\\n    background: rgba(10, 10, 10, 0.7);\\n\\n    cursor: pointer;\\n  }\\n\\n  .video-instructions:hover {\\n    background: rgba(0, 0, 0, 0.35);\\n  }\\n\\n  .video-instructions:hover .button-round {\\n    border: 2px solid rgba(255, 255, 255, 0.6);\\n  }\\n\\n  .video-instructions:hover h3 {\\n    opacity: 1;\\n  }\\n\\n  .next-video {\\n    position: absolute;\\n    z-index: 10;\\n    top: 0;\\n    left: 0;\\n\\n    display: flex;\\n    align-items: center;\\n    justify-content: center;\\n\\n    width: 100%;\\n    height: 100%;\\n    padding-bottom: 30px;\\n\\n    transition: 0.3s all ease;\\n\\n    background: rgba(10, 10, 10, 0.7);\\n\\n    cursor: pointer;\\n  }\\n\\n  .video-instructions button {\\n    border: none;\\n    background: none;\\n  }\\n\\n  .video-instructions .divie {\\n    display: flex;\\n    align-items: center;\\n    justify-content: center;\\n  }\\n\\n  .video-instructions__container h3 {\\n    max-width: 240px;\\n    margin: 0;\\n    margin-right: 10px;\\n\\n    transition: 0.3s all ease;\\n\\n    text-align: right;\\n    letter-spacing: 1px;\\n\\n    font-size: 17px;\\n    font-weight: 400;\\n\\n    opacity: 0.7;\\n  }\\n\\n  .video-instructions button img {\\n    width: 9px;\\n    height: 14px;\\n  }\\n</style>\\n\\n<section class=\\\"video-view\\\">\\n  <div class=\\\"outer-wrapper\\\">\\n    <div class=\\\"video-wrapper\\\">\\n\\n      <div class=\\\"video-meta-description\\\">\\n        <div class=\\\"video-count\\\">\\n          <h3 class=\\\"video-count__title\\\">Foto</h3>\\n          <p class=\\\"video-count__count\\\">{photoCount}</p>\\n        </div>\\n\\n        <h1 class=\\\"video-title\\\">{videoTitle}</h1>\\n      </div>\\n\\n      <div class=\\\"video-instructions__container\\\">\\n        <div class=\\\"video-instructions\\\">\\n          <div class=\\\"divie\\\">\\n            <h3>\\n              Maak momentopnames van de gebeurtenis, de laatste zie je straks\\n              terug\\n            </h3>\\n            <button>\\n              <span class=\\\"button-round\\\">\\n                <img src=\\\"/icons/arrow-solid.svg\\\" alt=\\\"\\\" />\\n              </span>\\n            </button>\\n          </div>\\n        </div>\\n        <video poster={posterSrc}>\\n          <source src={videoSrc} type=\\\"video/mp4\\\" />\\n        </video>\\n      </div>\\n\\n      <button id=\\\"snap\\\" on:click={takeSnapShot}>\\n        <img src=\\\"/icons/camera.svg\\\" alt=\\\"\\\" />\\n      </button>\\n    </div>\\n\\n    <div id=\\\"snapshots-taken\\\">\\n      <h4>Jouw foto's</h4>\\n    </div>\\n\\n    <canvas id=\\\"snapshot-canvas\\\" width=\\\"640\\\" height=\\\"480\\\" />\\n  </div>\\n</section>\\n\"],\"names\":[],\"mappings\":\"AAwHE,gBAAgB,cAAC,CAAC,AAChB,QAAQ,CAAE,KAAK,AACjB,CAAC,AAED,KAAK,cAAC,CAAC,AACL,KAAK,CAAE,KAAK,CACZ,MAAM,CAAE,KAAK,CAEb,UAAU,CAAE,IAAI,AAClB,CAAC,AAED,WAAW,cAAC,CAAC,AACX,QAAQ,CAAE,KAAK,CACf,OAAO,CAAE,EAAE,AACb,CAAC,AAED,WAAW,cAAC,CAAC,AACX,QAAQ,CAAE,QAAQ,CAClB,OAAO,CAAE,CAAC,CAEV,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,CACnB,eAAe,CAAE,MAAM,CAEvB,KAAK,CAAE,IAAI,CACX,SAAS,CAAE,KAAK,CAChB,MAAM,CAAE,KAAK,CACb,MAAM,CAAE,CAAC,CAAC,IAAI,CAEd,KAAK,CAAE,IAAI,AACb,CAAC,AAED,cAAc,cAAC,CAAC,AACd,QAAQ,CAAE,QAAQ,CAElB,WAAW,CAAE,KAAK,AACpB,CAAC,AAED,uBAAuB,cAAC,CAAC,AACvB,OAAO,CAAE,IAAI,CACb,eAAe,CAAE,aAAa,AAChC,CAAC,AAED,YAAY,cAAC,CAAC,AACZ,MAAM,CAAE,IAAI,CAAC,CAAC,CAEd,cAAc,CAAE,KAAK,CACrB,cAAc,CAAE,SAAS,CAEzB,KAAK,CAAE,OAAO,CAEd,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,GAAG,AAClB,CAAC,AAED,mBAAmB,cAAC,CAAC,AACnB,MAAM,CAAE,CAAC,CACT,UAAU,CAAE,GAAG,CAEf,cAAc,CAAE,MAAM,CACtB,cAAc,CAAE,SAAS,CAEzB,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,GAAG,AAClB,CAAC,AAED,mBAAmB,cAAC,CAAC,AACnB,MAAM,CAAE,CAAC,CACT,UAAU,CAAE,IAAI,CAEhB,cAAc,CAAE,KAAK,CAErB,WAAW,CAAE,kBAAkB,CAAC,CAAC,KAAK,CACtC,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,CAAC,AAChB,CAAC,AAED,mBAAK,MAAM,AAAC,CAAC,AACX,OAAO,CAAE,IAAI,AACf,CAAC,AAED,KAAK,cAAC,CAAC,AACL,QAAQ,CAAE,QAAQ,CAClB,KAAK,CAAE,CAAC,CACR,MAAM,CAAE,CAAC,CAET,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,CACnB,eAAe,CAAE,MAAM,CAEvB,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,CAEZ,OAAO,CAAE,CAAC,CACV,UAAU,CAAE,IAAI,CAAC,GAAG,CAAC,IAAI,CACzB,UAAU,CAAE,OAAO,CACnB,UAAU,CAAE,CAAC,CAAC,CAAC,CAAC,IAAI,CAAC,GAAG,CAAC,KAAK,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,AACnD,CAAC,AAED,mBAAK,CAAC,GAAG,cAAC,CAAC,AACT,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,AACd,CAAC,AAED,gBAAgB,cAAC,CAAC,AAChB,aAAa,CAAE,KAAK,CACpB,WAAW,CAAE,IAAI,AACnB,CAAC,AAED,8BAAgB,CAAC,EAAE,cAAC,CAAC,AACnB,KAAK,CAAE,IAAI,CACX,aAAa,CAAE,IAAI,CAEnB,cAAc,CAAE,GAAG,CACnB,cAAc,CAAE,SAAS,CAEzB,OAAO,CAAE,CAAC,CAEV,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,GAAG,AAClB,CAAC,AAED,cAAc,cAAC,CAAC,AACd,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,QAAQ,AACvB,CAAC,AAED,8BAA8B,cAAC,CAAC,AAC9B,QAAQ,CAAE,QAAQ,CAElB,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,AACd,CAAC,AAED,mBAAmB,cAAC,CAAC,AACnB,QAAQ,CAAE,QAAQ,CAClB,OAAO,CAAE,EAAE,CACX,GAAG,CAAE,CAAC,CACN,IAAI,CAAE,CAAC,CAEP,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,CACnB,eAAe,CAAE,MAAM,CAEvB,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,CACZ,cAAc,CAAE,IAAI,CAEpB,UAAU,CAAE,IAAI,CAAC,GAAG,CAAC,IAAI,CAEzB,UAAU,CAAE,KAAK,EAAE,CAAC,CAAC,EAAE,CAAC,CAAC,EAAE,CAAC,CAAC,GAAG,CAAC,CAEjC,MAAM,CAAE,OAAO,AACjB,CAAC,AAED,iCAAmB,MAAM,AAAC,CAAC,AACzB,UAAU,CAAE,KAAK,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,IAAI,CAAC,AACjC,CAAC,AAED,iCAAmB,MAAM,CAAC,aAAa,cAAC,CAAC,AACvC,MAAM,CAAE,GAAG,CAAC,KAAK,CAAC,KAAK,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,AAC5C,CAAC,AAED,iCAAmB,MAAM,CAAC,EAAE,cAAC,CAAC,AAC5B,OAAO,CAAE,CAAC,AACZ,CAAC,AAuBD,iCAAmB,CAAC,MAAM,cAAC,CAAC,AAC1B,MAAM,CAAE,IAAI,CACZ,UAAU,CAAE,IAAI,AAClB,CAAC,AAED,iCAAmB,CAAC,MAAM,cAAC,CAAC,AAC1B,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,CACnB,eAAe,CAAE,MAAM,AACzB,CAAC,AAED,4CAA8B,CAAC,EAAE,cAAC,CAAC,AACjC,SAAS,CAAE,KAAK,CAChB,MAAM,CAAE,CAAC,CACT,YAAY,CAAE,IAAI,CAElB,UAAU,CAAE,IAAI,CAAC,GAAG,CAAC,IAAI,CAEzB,UAAU,CAAE,KAAK,CACjB,cAAc,CAAE,GAAG,CAEnB,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,GAAG,CAEhB,OAAO,CAAE,GAAG,AACd,CAAC,AAED,iCAAmB,CAAC,MAAM,CAAC,GAAG,cAAC,CAAC,AAC9B,KAAK,CAAE,GAAG,CACV,MAAM,CAAE,IAAI,AACd,CAAC\"}"
};
...
const VideoSnapshot = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	let { videoSrc, videoTitle, localStorageLink, photoCount, posterSrc } = $$props;
  ...
  function setCanvasDimensions() {
	...
	return `<section class="video-view svelte-xbmc8f">
	  <div class="outer-wrapper svelte-xbmc8f">
	    <div class="video-wrapper svelte-xbmc8f">

	      <div class="video-meta-description svelte-xbmc8f">
	        <div class="video-count">
	          <h3 class="video-count__title svelte-xbmc8f">Foto</h3>
	          <p class="video-count__count svelte-xbmc8f">${escape(photoCount)}</p>
	        </div>

	        <h1 class="video-title svelte-xbmc8f">${escape(videoTitle)}</h1>
	      </div>

	      <div class="video-instructions__container svelte-xbmc8f">
	        <div class="video-instructions svelte-xbmc8f">
	          <div class="divie svelte-xbmc8f">
	            <h3 class="svelte-xbmc8f">
	              Maak momentopnames van de gebeurtenis, de laatste zie je straks
	              terug
	            </h3>
	            <button class="svelte-xbmc8f">
	              <span class="button-round svelte-xbmc8f">
	                <img src="/icons/arrow-solid.svg" alt="" class="svelte-xbmc8f">
	              </span>
	            </button>
	          </div>
	        </div>
	        <video${add_attribute("poster", posterSrc, 0)} class="svelte-xbmc8f">
	          <source${add_attribute("src", videoSrc, 0)} type="video/mp4">
	        </video>
	      </div>

	      <button id="snap" class="svelte-xbmc8f">
	        <img src="/icons/camera.svg" alt="" class="svelte-xbmc8f">
	      </button>
	    </div>

	    <div id="snapshots-taken" class="svelte-xbmc8f">
	      <h4 class="svelte-xbmc8f">Jouw foto's</h4>
	    </div>

	    <canvas id="snapshot-canvas" width="640" height="480" class="svelte-xbmc8f"></canvas>
	  </div>
	</section>`;
});
	...
	<div class="content svelte-1ahoxc5">
	  <div class="content-scroll svelte-1ahoxc5">
	    ...
	    <section class="story-intro svelte-1ahoxc5">
	      <h2 class="story-header svelte-1ahoxc5">The war left it's mark on many families</h2>
	      <h2 class="story-header svelte-1ahoxc5">Ours was no exception</h2>
	    </section>
	      ...
	      <div class="story__moment-container svelte-1ahoxc5">
	        <div class="stories svelte-1ahoxc5">
	          <figure class="story__moment background svelte-1ahoxc5">
	            ...
	            <img class="story__moment-img background svelte-1ahoxc5"${add_attribute("src", localStorage.getItem('snapshot1'), 0)} alt="">
	      ...
	      <div class="story__moment-container svelte-1ahoxc5">
	        <div class="stories svelte-1ahoxc5">
	          <figure class="story__moment svelte-1ahoxc5">
	            ...
	            ${ localStorage.getItem('snapshot1') === true ? `<img class="story__moment-img svelte-1ahoxc5"${add_attribute("src", localStorage.getItem('snapshot2'), 0)} alt="">` : `<img class="story__moment-img svelte-1ahoxc5"${add_attribute("src", localStorage.getItem('snapshot2'), 0)} alt="">` }
	            <figcaption class="svelte-1ahoxc5">
	              Na de uitvinding van de fotografie in 1839 werd de rol van de
	              expeditie overgenomen door de fotograaf. Landschappen, mensen en
	              hun leefomstandigheden waren de belangrijkste onderwerpen.
	      ...
	      <div class="story__moment-container svelte-1ahoxc5">
	        <div class="stories svelte-1ahoxc5">
	          <figure class="story__moment svelte-1ahoxc5">
	            ...
	            ${ localStorage.getItem('snapshot1') === true ? `<img class="story__moment-img svelte-1ahoxc5"${add_attribute("src", localStorage.getItem('snapshot1'), 0)} alt="">` : `<img class="story__moment-img svelte-1ahoxc5" src="/img/dummy4.jpg" alt="">` }
	            <figcaption class="svelte-1ahoxc5">
	              Na de uitvinding van de fotografie in 1839 werd de rol van de
	              expeditie overgenomen door de fotograaf. Landschappen, mensen en
	              hun leefomstandigheden waren de belangrijkste onderwerpen.
