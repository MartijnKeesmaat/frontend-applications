...
const Mask = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div class="mask-wrapper">
	  <canvas id="mask" width="500" height="300" class="svelte-17sfkrq"></canvas>
	  <img id="bg-img" src="./img/dummy1.jpg" alt="" class="svelte-17sfkrq">
	</div>
